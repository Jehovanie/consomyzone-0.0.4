...
/**
 * @ORM\Table(name="marche_de_france_backup")
 * @ORM\Entity(repositoryClass=MarcheBackupRepository::class)
 */
class MarcheBackup
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity=Marche::class)
     * @ORM\JoinColumns({
     ...
     * @return  self
     */ 
    public function setMarcheId($marche)
    {
        $this->marcheId = $marche;
