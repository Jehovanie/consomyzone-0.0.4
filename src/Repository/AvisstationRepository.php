 ...
 */
class AvisstationRepository extends ServiceEntityRepository
{
    ...
    public function updateAvis($idstation, $iduser, $note, $comment)
    {
    ...
    public function getNoteGlobale($idStation)
    {
    ...
    public function getNote($idStation, $user)
    {
        return $this->createQueryBuilder("r")
            ->where("r.station = :idS ")
