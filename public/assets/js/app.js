...
if (document.querySelector(".form_content_search_navbar_js")) {
  ...
  if (getDataInLocalStorage("type")) {
    ...
    search_form.setAttribute(
      "action",
      `${search_form.getAttribute("action")}/${baseOne}`
    );
  }
  ...
  search_form.addEventListener("submit", (e) => {
    ...
    if (
      current_url.includes("/restaurant") ||
      current_url.includes("/ferme") ||
      current_url.includes("/station")
    ) {
      if (cles0 === "" && cles1 === "") {
        e.preventDefault();
        ...
        new swal(
          "Attention !",
          "Veuillez renseigner au moins l'adresse!",
          "error"
        ).then((value) => {
          document
            .querySelector(".input_mots_cle_js")
            .classList.add("border_red");
        });
      } else if (cles1 === "") {
        e.preventDefault();

        new swal("Attention !", "L'adresse est obligatoire!", "error").then(
          (value) => {
            document
              .querySelector(".input_mots_cle_js")
              .classList.add("border_red");
  ...
  const inputs = [
    document.querySelector(".input_search_type_js"),
    document.querySelector(".input_mots_cle_js"),
  ];
...
if (document.querySelector(".form_content_search_navbar_js_mob")) {
  const search_form = document.querySelector(
    ".form_content_search_navbar_js_mob"
  );
  if (getDataInLocalStorage("type")) {
    const baseOne = getDataInLocalStorage("type");
    search_form.setAttribute(
  ...
  search_form.addEventListener("submit", (e) => {
    const cles0 = document
      .querySelector(".input_search_type_js_mob")
      .value.trim();
    ...
    if (
      ...
      if (cles0 === "" && cles1 === "") {
        ...
        new swal(
          ...
          document
            .querySelector(".input_mots_cle_js_mob")
            .classList.add("border_red");
        });
      } else if (cles1 === "") {
        e.preventDefault();
  ...
  const inputs = [
    document.querySelector(".input_search_type_js_mob"),
    document.querySelector(".input_mots_cle_js_mob"),
  ];
  inputs.forEach((input) => {
    input.addEventListener("input", () => {
      inputs.forEach((item) => {
...
if (document.querySelector(".b-example-divider .fa-solid")) {
  ...
  menu.addEventListener("click", () => {
    if (menu.getAttribute("data-toggle-state") === "show") {
      document.querySelector(".content_left_menu").style.animation =
        "toHideLeft 0.5s linear forwards";

      document.querySelector(".content_left_menu").style.overflow = "hidden";

      document.querySelector(".right_content").style.animation =
        "toScaleUpContent 0.5s linear forwards";

      document.querySelector(".content_nav_top").style.animation =
        "toScaleUpNavbar 0.5s linear forwards";
      ...
      document.querySelector(".content_left_menu").style.animation =
        "toShowLeft 0.5s linear forwards";

      document.querySelector(".right_content").style.animation =
        "toScaleDownContent 0.5s linear forwards";

      document.querySelector(".content_nav_top").style.animation =
        "toScaleDownNavbar 0.5s linear forwards";
...
if (document.querySelector(".custom-flash-inscription")) {
  const contentMessageFlash = document.querySelector(
...
if (document.querySelector("#show_list")) {
  ...
  btn_show_list.addEventListener("click", () => {
    ...
    document.querySelector(".left_content_home").style.animation =
      "toShowList 0.8s linear forwards";

    document.querySelector(".right_content_home").style.animation =
      "toScaleDown 0.8s linear forwards";
...
if (document.querySelector("#hide_list")) {
  ...
  btn_hide_list.addEventListener("click", () => {
    // contentMessageFlash.style.animation = "toShowFlass 0.8s linear forwards"
    document.querySelector(".left_content_home").style.animation =
      "toHideList 0.8s linear forwards";
    document.querySelector(".right_content_home").style.animation =
      "toScaleUp 0.8s linear forwards";
...
if (document.querySelector("#togglePasswordInscription")) {
  ...
  icon_eye.addEventListener("click", () => {
    const input_pass = document.querySelector(
      ".toggle_password_inscription_js_jheo"
    );
...
function makeLoadingDemandePartenariatEmail() {
  ...
  createChargement(
    document.querySelector(".content_chargement_email"),
    (c = "chargement_content content_chargement_email")
  );
}
...
function showResultSearchNavBar(type, nom, adresse, dep, nomDep, id) {
  ...
  switch (type) {
    case "ferme":
      a.setAttribute(
        "href",
        `/ferme/departement/${nomDep}/${dep}/details/${id}`
      );
      break;
    case "resto":
      ...
      a.setAttribute(
        "href",
        `/restaurant/departement/${nomDep}/${dep}/details/${id}`
      );
      break;
    case "station":
      ...
      a.setAttribute(
        "href",
        `/station/departement/${dep}/${nomDep}/details/${id}`
      );
      break;
    default:
      break;
  ...
  document
    .querySelector(".content_list_result_js_jheo")
    .appendChild(div_content);
}
...
function iconsChange() {
  document
    .querySelector(".icon_open_nav_left_jheo_js")
    .classList.toggle("fa-bars");
  document
    .querySelector(".icon_open_nav_left_jheo_js")
    .classList.toggle("fa-minuss");
}

if (document.querySelector(".icon_close_nav_left_jheo_js")) {
  document
    .querySelector(".icon_close_nav_left_jheo_js")
    .addEventListener("click", () => {
      if (
        !document
          .querySelector(".content_navleft_jheo_js")
...
if (document.querySelector(".open_nav_left_jheo_js")) {
  document
    .querySelector(".open_nav_left_jheo_js")
    .addEventListener("click", () => {
      if (
        document
          .querySelector(".content_navleft_jheo_js")
  ...
  document.querySelector("#menu-mobile").onclick = () => {
    if (document.querySelector("#container-mobile")) {
      document
        ...
        .classList.toggle("content_right_actualite-g_menu");
      document
        .querySelector(".card-pub")
        .classList.toggle("bgPersonnalisee_menu");
    } else if (document.querySelector(".content_right_actualite")) {
      document
        .querySelector(".content_right_actualite")
        .classList.toggle("content_right_actualite_menu");
    }
  };
}
...
if (document.querySelector("#menu-mobile-tribut")) {
  document.querySelector("#menu-mobile-tribut").onclick = () => {
    if (document.querySelector(".content_list_menu_tribut_mob")) {
      document
        .querySelector(".content_list_menu_tribut_mob")
        .classList.toggle("transition-mob");
    }
  };
}
...
if (document.querySelector(".list-nav-bar")) {
  ...
  if (document.querySelector(".tout-dem-tomm-js")) {
    ...
    document
      .querySelector(".station-page-mobile")
...
if (
  document.querySelector(".btn_close_comment_jheo_js") ||
  document.querySelector(".btn_cancel_comment_jheo_js")
) {
  const cta = [
    document.querySelector(".btn_close_comment_jheo_js"),
    document.querySelector(".btn_cancel_comment_jheo_js"),
...
/**upload file */
let dropZones = document.querySelectorAll(
  ".drop_zone__input_Nantenaina_css_js"
);
if (dropZones.length > 0 && dropZones != null) {
  document
    .querySelectorAll(".drop_zone__input_Nantenaina_css_js")
...
function updateThumbnail(dropZoneElement, file, customFile) {
  ...
  if (dropZoneElement.querySelector(".drop_zone__prompt_Nantenaina_css_js")) {
    dropZoneElement
      .querySelector(".drop_zone__prompt_Nantenaina_css_js")
      .remove();
  }
  ...
  if (file.type.startsWith("image/")) {
    ...
    thumbnailElement.style.backgroundImage =
      "url('/public/assets/image/doc.jfif')";
  }
}
  ...
  if ( agenda && agenda.isVisioCMZ == 1) {
    ...
    return (html = ` 
        ...
        <br>
           ...
           le <span id="dataDebutText" contenteditable="false" style="background-color:rgba(252, 130, 29, 1);">
                ${agenda.dateStart}
            </span>de  
        ...
        <p id="free_place" > 
        Nombre de places restantes: <span contenteditable="false" style="background-color:rgba(252, 130, 29, 1);"> ${agenda.place_libre} </span> place(s)</p>
        ${img}
        <p>Cordialement</p>
    ...
    return (html = ` 
        <p>Madame / Monsieur 
        <br>
            Je vous annonce la tenue de l'événement
            <span id="eventTitleText" style="background-color:rgba(252, 130, 29, 1);">
                ${agenda.title}
            </span>
            , qui aura lieu à
           ...
           <span id="dataDebutText" contenteditable="false" style="background-color:rgba(252, 130, 29, 1);">
                ${agenda.dateStart}
            </span> de  
            <span id="heureDebutText" contenteditable="false" style="background-color:rgba(252, 130, 29, 1);">
                ${agenda.heure_debut}
...
if (document.querySelector(".open-search-mobil-tomm-js")) {
  document
    .querySelector(".open-search-mobil-tomm-js")
    .addEventListener("click", () => {
      document
        .querySelector(".search-mobil-tomm-js")
        .classList.remove("search-resto-mobil-none");
      document
        .querySelector(".open-search-mobil-tomm-js")
        .classList.add("search-resto-mobil-none");
    });
...
function openSwalActif() {
  swal(
    "Veuillez vous connecter pour accéder à ce lien. \nVoulez-vous vous connecter?",
    {
      buttons: {
...
function openSwalActifPastille() {
  swal(
    "Pour pastiller veuillez vous connecter et puis créée une tribu-T avec l'extension restaurant activée.\nVoulez-vous vous connecter?",
    {
      buttons: {
        cancel: "Pas maintenant",
        connect: {
...
document
  .querySelectorAll(".btn_grise_non_actif_js_Elie")
  .forEach((btn_gris) => {
    btn_gris.addEventListener("click", function () {
      openSwalNonActif();
    });
...
function findInNet(server, denomination_f, adresse) {
  switch (server) {
    case "google":
      window.open(
        "https://www.google.com/search?q=" + denomination_f + " " + adresse
      );
      break;
    case "map":
      window.open(
        "https://www.google.com/maps?q=" + denomination_f + " " + adresse
      );
      break;
    case "thefork":
      window.open(
        "https://www.thefork.fr/restaurant/" +
          denomination_f.replaceAll(" ", "-") +
          "-r"
      );
      break;
    case "tripadvisor":
    ...
    case "michelin":
      window.open(
        "https://guide.michelin.com/fr/fr/restaurants?q=" + denomination_f
      );
      break;
  }
}
  ...
  swal({
    ...
    switch (value) {
      case "defeat":
        swal(
          "Merci !",
          "Vous n'avez pas encore decidé, revenez plus tard.",
          "warning"
        );
        break;
...
function getListeDemandePartenariat(e) {
  document.querySelector(
    ".content_chargement_liste_partenaire_nanta_js"
  ...
  fetch("/user/liste/demande/partenariat")
    ...
    .then((r) => {
      ...
      document
        .querySelector(".content_chargement_liste_partenaire_nanta_js")
        .appendChild(table);
      ...
      for (let i = 0; i < r.length; i++) {
        ...
        btnDetail.onclick = () => {
          ...
          let fnameText =
            r[i].firstname != ""
              ? r[i].firstname
              : "Le partenaire n'a pas fourni cette information";
          ...
          if (adrComplet != "") {
            ...
            document.querySelector(".adresseD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          let commerceText =
            r[i].commerce != ""
          ...
          if (r[i].facebook || r[i].facebook != "") {
            ...
            document.querySelector(".facebookD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          ...
          if (r[i].twitter || r[i].twitter != "") {
            ...
            document.querySelector(".twitterD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          ...
          if (r[i].website || r[i].website != "") {
            ...
            document.querySelector(".websiteD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          ...
          if (r[i].linkedin || r[i].linkedin != "") {
            ...
            document.querySelector(".linkedinD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          ...
          if (r[i].siren || r[i].siren != "") {
            ...
            document.querySelector(".sirenD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
          ...
          if (r[i].nomCommerce || r[i].nomCommerce != "") {
            ...
            linkNomCommerce.href =
              "https://www.google.com/search?q=" + r[i].nomCommerce;
            ...
            document
              .querySelector(".nomCommerceD")
              .appendChild(linkNomCommerce);
          } else {
            document.querySelector(".nomCommerceD").textContent =
              "Le partenaire n'a pas fourni cette information";
          }
        };
        ...
        btnValidate.setAttribute(
          "class",
          "btn btn-primary validatePartenariat"
        );
...
function sendEmailPropositionPartenariat() {
  ...
  fetch(request).then((r) => {
    if (r.status === 200 && r.ok) {
      ...
      swal("Bravo !", "Demande bien envoyée", "success").then((value) => {
        $("#devenirPartenaireModal").modal("hide");
      });
    } else {
      deleteChargement("chargement_content");
      swal("Erreur !", "Erreur 500", "error").then((value) => {
        $("#devenirPartenaireModal").modal("hide");
      });
    }
  });
      ...
      case "cancel": {
        ...
        fetch(request).then((response) => {
          if (response.status == 200 && response.ok) {
            ...
            swal("Merci !", "Demande de partenariat refuser.", "success").then(
              (value) => {
                swal({
                  title:
                    "Voulez vous lui ecrire un email pour lui expliquez les raison du refus?",
                  icon: "info",
                  buttons: {
                    catch: {
                      text: "Non",
                  ...
                  switch (value1) {
                    case "cancel": {
                      let dataEmail = {
                        generateAuto: true,
                        emailCore:
                          "Désolé ! Votre demande de partenariat a été refusée",
                        objectEmail: "Demande de partenariat refusée",
                      };

                      let request = new Request(
                        "/proposition/partenariat/send/email",
                        {
                          method: "POST",
                          headers: {
                            Accept: "application/json",
                      ...
                      fetch(request).then((r) => {
                        if ((r.status = 200 && r.ok)) {
                          swal(
                            "Info",
                            `Le mail qui lui explique le refus a été envoyer et géné automatiquement par CMZ`,
                            "success"
                          );
                        }
                      });
      ...
      case "Accepter": {
        ...
        fetch(request).then((response) => {
          if (response.status == 200 && response.ok) {
            ...
            swal("Merci !", "Demande de partenariat approuvée", "success").then(
              (value) => {
                swal({
                  ...
                  switch (value1) {
                    case "cancel": {
                      let dataEmail = {
                        generateAuto: true,
                        emailCore:
                          "Bravo ! Votre demande de partenariat a été acceptée",
                      ...
                      fetch(request).then((r) => {
                        if ((r.status = 200 && r.ok)) {
                          swal(
                            "Info",
                            `Le mail qui lui explique l'acceptation a été envoyé et géné automatiquement par CMZ`,
                            "success"
                          );
                        }
                      });
...
function sendFeedBackForPartenariat() {
  ...
  fetch(request).then((r) => {
    if ((r.status = 200 && r.ok)) {
      swal(
        "Info",
        `Le mail qui lui explique le refus a été envoyée`,
        "success"
      ).then((value) => {
...
function reorganisePastille() {
  ...
  if (document.querySelector(".mainContainerLogoTribu")) {
    ...
    if (container.querySelectorAll(".img_nantenaina")) {
      ...
      Array.from(container.querySelectorAll(".img_nantenaina")).forEach(
        (item) => {
          let bRect = item.getBoundingClientRect();
          let itemWidth = bRect.width;
          item.style.zIndex = 4 - j;
          i += itemWidth;
          if (imLength > 4) if (j > 0) item.style.marginLeft = "-10px";
          j++;
...
function showNextImage() {
  let mainContainerLogoTribu = document.querySelector(
...
function expand(e) {
  ...
  document
    .querySelector("#bodyVisioMessageElie")
    .classList.remove("minRightVisioBody");
}
...
if (document.querySelector("#visioMessageElie")) {
  if (
    document
      ...
      .classList.contains("minRightModal")
  ) {
...
function reduire(e) {
  ...
  document
    .querySelector("#bodyVisioMessageElie")
    .classList.add("minRightVisioBody");
}
 ...
 * @return call function to generate each toast message
 */
function generateOneToastMessage(
  toastId,
  message,
  type,
  duration,
  isForConnexion = false
) {
  ...
  const btn_alert = "btn btn-danger",
    btn_info = "btn btn-primary",
    btn_news = "btn btn-info";
...
function closeAskClientToUseCookie() {
  if (document.querySelector(`.ask_client_to_use_cookie_jheo_js`)) {
    const btnClose = document.querySelector(
      `.ask_client_to_use_cookie_jheo_js`
    );
...
function clickedOnToastMessage(toastID) {
  if (document.querySelector(`.toast_message_${toastID}_jheo_js`)) {
    const oneToast = document.querySelector(
      `.toast_message_${toastID}_jheo_js`
    );
...
if (document.querySelector(".btn-navright-tribut-tomm-js")) {
  document
    .querySelector(".btn-navright-tribut-tomm-js")
    .addEventListener("click", () => {
      document
...
if (document.querySelector(".btn-navright-en-lign-tomm-js")) {
  document
    .querySelector(".btn-navright-en-lign-tomm-js")
    .addEventListener("click", () => {
      document
        .querySelector(".en-lign-mobile-tomm-js")
        .classList.toggle("responsif-none");
      document
      ...
      document
        ...
        .classList.toggle("responsif-none");
      document
        .querySelector(".menu-en-lign-tomm-js")
        .classList.toggle("span-btn-menu-en-lign");
    });
}
...
if (document.querySelector("#change_idle_param_tom_js"))
  document
    .querySelector("#change_idle_param_tom_js")
 ...
 */
document
  .querySelectorAll("div.qf > div > div.bloc-text-message")
  .forEach((div_mess) => {
...
function setViewTribu(a, b) {
  ...
  if (a == "g") {
    ...
    document
      .querySelector(".content_list_resto_js_g")
      .classList.remove("d-none");
  }
}
