...
function create_map_content_not_async(geos, id_dep = null, map_for_type = "home") {
    ...
    var map = L.map('map', {
        zoomControl: false,
        center:id_dep ? L.latLng(centers[id_dep].lat, centers[id_dep].lng) : (memoryCenter ? L.latLng(memoryCenter.coord.lat,memoryCenter.coord.lng) :  L.latLng(centers[id_dep].lat, centers[id_dep].lng)),
        zoom: memoryCenter ? memoryCenter.zoom : 12, 
        layers: [tiles] 
    });
