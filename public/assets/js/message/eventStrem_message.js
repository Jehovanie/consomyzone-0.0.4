...
if(document.querySelector(".content_entete_js_jheo")){

    ////id user sending message
    const user_id = document.querySelector(".content_entete_js_jheo").getAttribute("data-toggle-id-user-to")
    ...
    evtSource.onmessage = function(event) {
        ...
        all_messages.forEach(message => {
            ...
            if(!document.querySelector("#message_" + message.id )){
