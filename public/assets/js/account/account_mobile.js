if( document.querySelector(".information_user_conected_jheo_js")){
    ...
    event_source_nbr_message.onmessage=function(event){
        ...
        if(parseInt(new_nbr_message) != 0){
            ...
            document.querySelector(".nbr_message_jheo_js_mobile").parentElement.style.opacity="1"



            //// get the last number message

            const old_nbr_message =document.querySelector(".nbr_message_jheo_js_mobile").innerText
            ...
            if( parseInt(old_nbr_message) < parseInt(new_nbr_message)){
                ...
                document.querySelector(".nbr_message_jheo_js_mobile").innerText= new_nbr_message;

            }

        }else{ //// if  hide the badge message

            document.querySelector(".nbr_message_jheo_js_mobile").parentElement.style.opacity="0"
    ...
    event_source_notification.onmessage = function(event) {
        ...
        if( document.querySelector(".nbr_notification_jheo_js_mobile")){

            const nbr_actual_notification = document.querySelector(".nbr_notification_jheo_js_mobile").innerText;
            ...
            if(parseInt(nbr_actual_notification) < new_notification.length){
                ...
                if( notification_unshow.length === 0 ){
                    ...
                    document.querySelector(".nbr_notification_jheo_js_mobile").parentElement.style.opacity="1"

                    document.querySelector(".nbr_notification_jheo_js_mobile").innerText= notification_unshow.length;

                }



                if( document.querySelector(".content_card_notification_jheo_js_mobile")){
                    ...
                    document.querySelector(".content_card_notification_jheo_js_mobile").innerHTML ="";
                    ...
                    new_notification.forEach(item => {
                        ...
                        createAndAddCardNotification(
                            ...
                            item.id,
                            document.querySelector(".content_card_notification_jheo_js_mobile"),
...
function createAndAddCardMessageMobile(id,other_id, firstname, lastname,message,isForMe, isRead, profil){
    ...
    /// if the user is not in the popup message list
        ...
        document.querySelector(".content_card_message_jheo_js_mobile").appendChild(card);
    }
...
function deleteCardElementMobile(){

    const all_cards = document.querySelectorAll(".card_js_jheo");

    const parent_card = document.querySelector(".content_card_notification_jheo_js_mobile");
...
function createBadgeNotifContent(){
    ...
    //     <span class="nbr_notification_jheo_js_mobile">0</span>
    ...
    span_nbr_notification.classList.add("nbr_notification_jheo_js_mobile")
