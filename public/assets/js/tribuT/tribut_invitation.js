...
if (document.querySelector(".content_form_send_invitation_email_js_jheo")) {
	...
	document.querySelectorAll(".invitation_email_js_jheo").forEach((item) => {
		item.addEventListener("click", () => {
			...
			document
				.querySelector("#modal_sendEmail")
				.setAttribute("data-table", parentElement.getAttribute("data-table"));
		});
	});
	...
	form_parent.querySelector(".btn_send_invitation_js_jheo").addEventListener("click", (e) => {
		...
		let data = {
			table: document.querySelector("#modal_sendEmail").getAttribute("data-table"),
			principal: "",
			cc: cc_destinataire,
			object: "",
			description: "",
