...
// centerss[77] = {
//     lat: 48.70636916361882,
//     lng: 2.5845336914062504,
//     zoom: 9
// }

// centerss[78] = {
//     lat: 48.79284254919814,
//     lng: 1.7523193359375002,
//     zoom: 10
// }

// centerss[91] = {
//     lat: 48.57887856622344,
//     lng: 2.1025085449218754,
//     zoom: 9
// }

// centerss[92] = {
//     lat: 48.8563575709925,
//     lng: 2.191085815429688,
//     zoom: 10
// }
...
// centerss[94] = {
//     lat: 48.79386032793792,
//     lng: 2.4087524414062504,
//     zoom: 11
// }

// centerss[95] = {
//     lat: 49.08241158506453,
//     lng: 2.0132446289062504,
//     zoom: 9
// }
    ...
    if (window.location.href.includes("/restaurant/arrondissement/specific")) {
        ...
        fetch(url)
            ...
            .then(response1 => {
                ...
                const cntrJson = JSON.parse(JSON.stringify(centers[75]))
        ...
        fetch(url)
            ...
            .then(response1 => {
                ...
                const zoom = dep ?  centers[parseInt(dep)].zoom : 5;
                const memoryCenter= localStorage.getItem("memoryCenter") ? JSON.parse(localStorage.getItem("memoryCenter")) : null;
                map = L.map('map', { 
                    zoomControl: false,
                    center:dep ? L.latLng(centers[dep].lat, centers[dep].lng) : (memoryCenter ? L.latLng(memoryCenter.coord.lat,memoryCenter.coord.lng) :  L.latLng(centers[dep].lat, centers[dep].lng)),
                    zoom: zoom, 
                    layers: [tiles] 
                });
...
function chargeMapAndMarkers(response1, map, markers) {
    ...
    response1.forEach(item => {
        ...
        marker.on('click', (e) => {
            ...
            // let remove = document.getElementById("remove-detail-resto")
