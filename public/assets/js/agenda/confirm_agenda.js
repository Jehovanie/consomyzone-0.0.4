			...
			.then((response) => {
				if (response.response === "accepted") {
					...
					if (response.type == "Type") {
						swal(
							"Message !",
							"Votre choix a été bien pris en compte.\r\n" +
								" L'événement devrait s'afficher dans votre agenda et" +
								"vous recevrez un email de présence le jour de l'événement.\r\n" +
								"Vous allez être redirigé vers la page d'inscription de CONSOMYZONE pour vous incrire.",
							"success"
						).then((value) => {
						...
						swal(
							...
							"Votre choix a été bien pris en compte.\r\n" +
								" L'événement devrait s'afficher dans votre agenda et" +
								"vous recevrez un email de présence le jour de l'événement.\r\n" +
								"Vous allez être redirigé vers CONSOMYZONE.",
							"success"
						).then((value) => {
							location.href = "/";
						});
					...
					if (response.type == "Type") {
						swal(
							"Message !",
							"Vous avez déjà accepté votre invitation à l'événement.\r\n" +
